...
use frame_support::traits::{
	Currency, ExistenceRequirement, Imbalance, OnUnbalanced, OnKilledAccount, WithdrawReasons,
};
...
pub mod pallet {
	...
	#[pallet::storage]
	#[pallet::getter(fn account_connection)]
	pub type AccountConnection<T: Config> = StorageMap<_, Blake2_128Concat, H160, Option<H160>, ValueQuery>;
